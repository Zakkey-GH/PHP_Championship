...
# 画像ファイルのアップロード
# image_path  = "/Applications/XAMPP/xamppfiles/htdocs/php_Championship/MyProject/myproject/uploads/Ben_4.png" #input("画像ファイルのパスを入力してください: ")
# #image_path  = "/uploads/Ben_3.png"
